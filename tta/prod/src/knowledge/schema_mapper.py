...
class SchemaMapper:
    ...
    def register_relationship_type(
        ...
        logger.info(
            f"Registered relationship type mapping for {relationship_type} -> {label}"
        )
    ...
    def map_to_node(self, entity_type: str, obj: dict[str, Any]) -> dict[str, Any]:
        ...
        return {"label": mapper["label"], "id": node_id, "properties": properties}
...
def _initialize_default_mappings(mapper: SchemaMapper) -> None:
    ...
    mapper.register_relationship_type(
        ...
        target_type="Item",
        property_mapping={"equipped": "equipped", "quantity": "quantity"},
    )
    ...
    mapper.register_relationship_type(
        ...
        source_type="Character",
        target_type="Memory",
        property_mapping={"clarity": "clarity", "last_recalled": "last_recalled"},
    )
    ...
    mapper.register_relationship_type(
        ...
        source_type="Quest",
        target_type="Character",
        property_mapping={"date_assigned": "date_assigned", "progress": "progress"},
    )
