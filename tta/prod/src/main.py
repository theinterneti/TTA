...
try:
    from .agents import generate_narrative, process_input
    from .models import AgentState, CharacterState, GameState
except ImportError:
    # Fallback implementations for missing dependencies
    logger.warning("Missing dependencies, using mock implementations")
    ...
    def process_input(user_input):
        ...
        return {"intent": "look", "entities": []}

    def generate_narrative(state):
        """Mock narrative generation."""
        return {"response": "This is a mock narrative response."}
