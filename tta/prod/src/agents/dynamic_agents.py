...
Always maintain consistency with existing lore and ensure locations serve both gameplay and narrative purposes."""
    ...
    def modify_location(
        self, location_id: str, modification_reason: str, current_state: dict[str, Any]
    ) -> dict[str, Any]:
        """
...
Always maintain consistency with existing lore and ensure characters feel authentic within their world."""
    ...
    def generate_character(
        ...
        context = {
            ...
            or "To provide an interesting interaction for the player",
        }
    ...
    def modify_character(
        self, character_id: str, modification_reason: str, current_state: dict[str, Any]
    ) -> dict[str, Any]:
        """
...
Always prioritize maintaining a coherent, believable world that supports immersive gameplay."""
    ...
    def validate_content(
        self, content: str, content_type: str, related_entities: list[dict[str, Any]]
    ) -> dict[str, Any]:
        """
    ...
    def identify_new_concepts(
        self, content: str, existing_concepts: list[dict[str, Any]]
    ) -> dict[str, Any]:
        """
        ...
        # Create the context
        context = {"content": content, "existing_concepts": existing_concepts}
...
Always ensure that the multiverse feels cohesive while still offering diverse and distinct experiences."""
    ...
    def generate_universe(
        self, universe_name: str, theme: str, core_concepts: list[str]
    ) -> dict[str, Any]:
        """
...
def create_dynamic_agents(
    neo4j_manager=None, tools: dict[str, Callable] = None
