...
class ComprehensiveNarrativeAnalysisStudy:
    ...
    async def _analyze_study_results(self) -> StudyResults:
        ...
        for profile_name in set(m.player_profile for m in self.session_metrics):
            profile_sessions = [
        ...
        for archetype_name in set(m.character_archetype for m in self.session_metrics):
            archetype_sessions = [
                m
        ...
        for setting_name in set(m.world_setting for m in self.session_metrics):
            setting_sessions = [
