...
class TestEmotionalSafetySystem:
    ...
    async def test_crisis_protocol_activation(
        ...
        assert distressed_session_state.context["crisis_intervention_active"]
        ...
        assert distressed_session_state.context["narrative_paused_for_safety"]
    ...
    async def test_provide_immediate_support(
        ...
        assert session_state.context["immediate_support_provided"]
        assert "support_interventions" in session_state.context
        assert session_state.context["content_warning_suggested"]
    ...
    async def test_offer_coping_support(self, emotional_safety_system, session_state):
        ...
        assert session_state.context["coping_support_offered"]
    ...
    def test_intervention_library_loading(self, emotional_safety_system):
        ...
        for _intervention_type, intervention_list in interventions.items():
    ...
    def test_coping_strategies_loading(self, emotional_safety_system):
        ...
        for _emotion, strategy_list in strategies.items():
    ...
    def test_monitoring_control(self, emotional_safety_system):
        ...
        assert not emotional_safety_system.monitoring_enabled

        # Test enable
        emotional_safety_system.enable_monitoring()
        assert emotional_safety_system.monitoring_enabled
