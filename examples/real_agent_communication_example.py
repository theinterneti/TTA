...
from src.agent_orchestration.enhanced_coordinator import (
    EnhancedRedisMessageCoordinator, ScalableWorkflowCoordinator
)
from src.agent_orchestration.config.real_agent_config import get_real_agent_config
from src.agent_orchestration.monitoring import get_system_monitor, AlertManager
    ...
    workflow_steps = [
        ...
        },
        {
            ...
            'config': {
                ...
                'updates': {
                    'discovered_runes': True,
                    'location': 'temple_wall'
                }
            },
            'update_context': True
        },
...
async def demonstrate_concurrent_workflows():
    ...
    async def run_workflow(workflow_id: int):
        ...
        steps = [
            ...
            {
                'type': 'nga',
                'config': {'prompt': f'Generate story for player {workflow_id} in dungeon'},
                'update_context': True
            }
        ]
