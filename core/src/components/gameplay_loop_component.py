...
from .gameplay_loop.base import ComponentPriority, GameplayLoopManager
...
class GameplayLoopComponent(Component):
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        super().__init__(
            ...
            ],  # Depends on agent orchestration
            config=config or {},
        )
        ...
        # Core manager
        self._manager: GameplayLoopManager | None = None

        # Component instances
        self._session_manager: SessionManager | None = None
        self._narrative_engine: NarrativeEngine | None = None
        self._choice_architecture: ChoiceArchitectureManager | None = None
    ...
    def get_manager(self) -> GameplayLoopManager | None:
    ...
    def get_narrative_engine(self) -> NarrativeEngine | None:
        """Get the narrative engine component."""
        return self._narrative_engine

    def get_choice_architecture(self) -> ChoiceArchitectureManager | None:
        """Get the choice architecture manager component."""
        return self._choice_architecture

    def get_consequence_system(self) -> ConsequenceSystem | None:
    ...
    async def process_user_action(
        ...
        try:
            ...
            if self._session_manager:
                session_context = await self._session_manager.get_session_context(
                    session_id
                )
