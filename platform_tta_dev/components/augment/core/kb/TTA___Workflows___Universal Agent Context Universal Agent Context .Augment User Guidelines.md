---
title: Augster System - Modular Architecture
tags: #TTA
status: Active
repo: theinterneti/TTA
path: packages/universal-agent-context/.augment/user_guidelines.md
created: 2025-11-01
updated: 2025-11-01
---
# [[TTA/Workflows/Augster System - Modular Architecture]]
...
- **[[TTA/Workflows/augster-modular-architecture|Architecture Documentation]]** - Component breakdown, triggering conditions, troubleshooting
- **[[TTA/Workflows/augster-migration-guide|Migration Guide]]** - Behavioral equivalence, rollback procedure
- **[[TTA/Workflows/augster-usage-guide|Usage Guide]]** - How to use and customize the modular system
