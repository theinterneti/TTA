...
class TestALLanguageServer:
    ...
    def test_find_symbol(self, language_server: SolidLanguageServer) -> None:
        ...
        assert SymbolUtils.symbol_tree_contains_name(symbols, 'Page 50001 "TEST Customer Card"'), (
            "TEST Customer Card page not found in symbol tree"
        )
        assert SymbolUtils.symbol_tree_contains_name(symbols, 'Page 50002 "TEST Customer List"'), (
        ...
        assert SymbolUtils.symbol_tree_contains_name(symbols, "Codeunit 50001 PaymentProcessorImpl"), (
        ...
        assert SymbolUtils.symbol_tree_contains_name(symbols, "Interface IPaymentProcessor"), (
