    ...
    def turn_4_browse_worlds(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                worlds = worlds_response.get("worlds", []) if isinstance(worlds_response, dict) else worlds_response

                # Select Mindful Meadows if available
                for world in worlds:
                    if world.get("name") == "Mindful Meadows" or world.get("world_id") == "therapeutic_world_001":
