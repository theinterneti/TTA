...
def create_html_report(results, model_results, output_dir):
    ...
    <body>
        ...
        <h2>Overview</h2>
        <p>Models tested: {len(model_results)}</p>
        <p>Configurations: Quantizations: {results['quantizations']}, Flash Attention: {results['flash_attention_settings']}, Temperatures: {results['temperatures']}</p>
