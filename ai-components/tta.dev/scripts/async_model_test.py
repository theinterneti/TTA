...
class AsyncModelTester:
    ...
    def analyze_results(self, results: dict[str, Any]) -> dict[str, Any]:
        ...
        # Calculate averages
        for _model_name, performance in analysis["model_performance"].items():
        ...
        for _prompt_type, models in analysis["prompt_type_performance"].items():
            for _model_name, performance in models.items():
                performance["avg_tokens_per_second"] = (
                    sum(performance["tokens_per_second"])
                    / len(performance["tokens_per_second"])
                    if performance["tokens_per_second"]
