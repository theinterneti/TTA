...
from src.player_experience.utils.compatibility_checker import CompatibilityChecker, CompatibilityWeights
from src.player_experience.models.world import WorldDetails, WorldPrerequisite
from src.player_experience.models.character import Character, CharacterAppearance, CharacterBackground, TherapeuticProfile, TherapeuticGoal
from src.player_experience.models.enums import DifficultyLevel, TherapeuticApproach, IntensityLevel
...
class TestCompatibilityChecker(unittest.TestCase):
    ...
    def test_therapeutic_readiness_compatibility(self):
        ...
        readiness_factor = next(
            factor for factor in report.compatibility_factors 
    ...
    def test_world_recommendations(self):
        ...
        available_worlds = [self.beginner_world, self.advanced_world, self.trigger_world]
    ...
    def test_recommendations_and_warnings_generation(self):
        ...
        self.assertTrue(
            any(keyword in recommendation_text for keyword in 
                ["prerequisite", "easier", "beginner", "readiness"])
        )
        
        # Test with trigger world (should generate safety warnings)
        trigger_report = self.compatibility_checker.calculate_comprehensive_compatibility(
            self.test_character, self.trigger_world
        )
        ...
        self.assertTrue(
            any(keyword in warning_text for keyword in 
                ["trigger", "content", "support", "difficult"])
        )
