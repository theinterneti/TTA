...
from src.player_experience.models.auth import AuthenticatedUser, UserRole, Permission
...
class TestPrivacyCompliance(unittest.TestCase):
    ...
    def test_privacy_settings_management(self):
        ...
        # Retrieve settings
        retrieved_settings = self.privacy_service.get_privacy_settings(self.test_user_id)
        ...
        self.assertEqual(retrieved_settings.data_retention_preference, DataRetentionPeriod.MEDIUM_TERM)
    ...
    def test_consent_management_workflow(self):
        ...
        consent_records = self.privacy_service.consent_records.get(self.test_user_id, [])
        ...
        # Withdraw consent
        withdrawal_success = self.privacy_service.withdraw_consent(self.test_user_id, consent_id)
        ...
        invalid_withdrawal = self.privacy_service.withdraw_consent(self.test_user_id, "nonexistent")
    ...
    def test_data_anonymization_workflow(self):
        ...
        second_anonymization = self.privacy_service.anonymize_user_data(self.test_user_id)
        self.assertEqual(
            anonymization_summary["anonymous_id"], 
            second_anonymization["anonymous_id"]
        )
    ...
    def test_data_processing_records_management(self):
        ...
        self.assertEqual(retrieved_record.data_category, DataCategory.THERAPEUTIC_CONTENT)
    ...
    def test_gdpr_rights_implementation(self):
        ...
        consent_id = self.privacy_service.record_consent(consent)
        objection_success = self.privacy_service.withdraw_consent(self.test_user_id, consent_id)
    ...
    def test_therapeutic_data_protection_integration(self):
        ...
        therapeutic_records = [
            r for r in records 
            if r.data_category == DataCategory.THERAPEUTIC_CONTENT
        ]
        ...
        self.assertEqual(therapeutic_record.processing_purpose, ProcessingPurpose.CONSENT)
        ...
        anonymized_content = self.privacy_service.anonymization_service.anonymize_therapeutic_content(
            content_with_pii
        )
        ...
        self.assertNotIn("john.smith@email.com", anonymized_content)  # Should be anonymized
