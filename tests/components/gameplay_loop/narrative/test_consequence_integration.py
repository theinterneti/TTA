...
class TestConsequenceIntegration:
    ...
    def session_state(self):
        ...
        state.progress_metrics = {"anxiety_management": 0.4, "communication_skills": 0.3}
    ...
    @pytest.mark.asyncio
    async def test_choice_processing_with_consequences(self, choice_processor, session_state, therapeutic_choice):
        ...
        choice_processor._load_choice_consequences = AsyncMock(return_value=[])  # No legacy consequences
        choice_processor._trigger_therapeutic_moment = AsyncMock()
        
        # Process the choice
        result = await choice_processor.process_choice(
            therapeutic_choice.choice_id,
            session_state,
    ...
    @pytest.mark.asyncio
    async def test_therapeutic_outcomes_applied_to_session(self, choice_processor, session_state, therapeutic_choice):
    ...
    @pytest.mark.asyncio
    async def test_learning_opportunities_stored_in_session(self, choice_processor, session_state, therapeutic_choice):
    ...
    @pytest.mark.asyncio
    async def test_consequence_history_tracking(self, choice_processor, session_state, therapeutic_choice):
    ...
    @pytest.mark.asyncio
    async def test_emotional_impact_application(self, choice_processor, session_state, therapeutic_choice):
    ...
    @pytest.mark.asyncio
    async def test_narrative_impact_application(self, choice_processor, session_state, therapeutic_choice):
    ...
    @pytest.mark.asyncio
    async def test_character_changes_application(self, choice_processor, session_state, therapeutic_choice):
    ...
    @pytest.mark.asyncio
    async def test_consequence_event_publishing(self, choice_processor, session_state, therapeutic_choice, event_bus):
    ...
    @pytest.mark.asyncio
    async def test_metrics_tracking(self, choice_processor, session_state, therapeutic_choice):
        ...
        assert final_metrics["consequences_generated"] == initial_consequences_generated + 1
        assert final_metrics["consequences_applied"] == initial_consequences_applied + 1
    
    @pytest.mark.asyncio
    async def test_backward_compatibility_with_legacy_consequences(self, choice_processor, session_state, therapeutic_choice):
        ...
        choice_processor._load_choice = AsyncMock(return_value=therapeutic_choice)
        choice_processor._apply_choice_effects = AsyncMock()
        choice_processor._load_choice_consequences = AsyncMock(return_value=[legacy_consequence])
        ...
        choice_processor._apply_consequence.assert_called_once_with(legacy_consequence, session_state)
