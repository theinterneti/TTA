...
class TestSessionIntegrationManager(unittest.TestCase):
    ...
    async def test_switch_character_world_context_new_session(self):
    ...
    async def test_switch_character_world_context_existing_session(self):
    ...
    async def test_update_session_interaction(self):
    ...
    async def test_add_progress_marker(self):
    ...
    async def test_update_therapeutic_settings(self):
...
if __name__ == '__main__':
    ...
    # Add test cases
    suite.addTest(TestSessionRepository('test_serialize_session_context'))
    suite.addTest(TestSessionRepository('test_deserialize_session_context'))
    ...
    repo_test = TestSessionRepository()
    repo_test.setUp()
    run_async_test(repo_test.test_create_session)
    run_async_test(repo_test.test_get_session_from_cache)
    run_async_test(repo_test.test_pause_session)
    run_async_test(repo_test.test_end_session)
    
    # Test manager async methods
    manager_test = TestSessionIntegrationManager()
    manager_test.setUp()
    run_async_test(manager_test.test_create_session)
    run_async_test(manager_test.test_switch_character_world_context_new_session)
    run_async_test(manager_test.test_switch_character_world_context_existing_session)
    run_async_test(manager_test.test_pause_session)
    run_async_test(manager_test.test_resume_session)
    run_async_test(manager_test.test_end_session)
    run_async_test(manager_test.test_update_session_interaction)
    run_async_test(manager_test.test_add_progress_marker)
    run_async_test(manager_test.test_update_therapeutic_settings)
    
    # Test integration
    integration_test = TestSessionLifecycleIntegration()
    integration_test.setUp()
    run_async_test(integration_test.test_complete_session_lifecycle)
