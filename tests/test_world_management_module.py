...
from src.player_experience.models.world import WorldParameters, CompatibilityReport
from src.player_experience.models.enums import DifficultyLevel, TherapeuticApproach
...
class TestWorldManagementModule(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(manager_with_deps.world_state_manager, mock_world_state_manager)
        self.assertEqual(manager_with_deps.therapeutic_environment_generator, mock_therapeutic_generator)
    ...
    def test_get_available_worlds_with_character(self):
        ...
        self.assertGreaterEqual(worlds[0].compatibility_score, worlds[1].compatibility_score)
    ...
    def test_customize_world_parameters_valid(self):
        ...
        customized_world = self.world_manager.customize_world_parameters(world_id, parameters)
        ...
        self.assertIsInstance(customized_world.compatibility_report, CompatibilityReport)
    ...
    def test_world_parameters_validation(self):
        ...
        valid_params = WorldParameters(
            therapeutic_intensity=0.5,
            session_length_preference=30
        )
        
        is_valid = self.world_manager._validate_world_parameters(world_details, valid_params)
    ...
    def test_advanced_compatibility_checking_with_character_object(self):
        ...
        from src.player_experience.models.character import Character, CharacterAppearance, CharacterBackground, TherapeuticProfile
    ...
    def test_get_world_recommendations(self):
        ...
        # Get recommendations
        recommendations = self.world_manager.get_world_recommendations(test_character, max_recommendations=3)
        ...
        for recommendation in recommendations:
            ...
            self.assertGreaterEqual(recommendation["world_summary"].compatibility_score, 0.0)
            self.assertLessEqual(recommendation["world_summary"].compatibility_score, 1.0)
    ...
    def test_assess_world_suitability_for_character(self):
        ...
        # Assess suitability
        assessment = self.world_manager.assess_world_suitability_for_character(test_character, world_id)
