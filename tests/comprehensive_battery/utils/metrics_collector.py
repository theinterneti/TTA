...
class TestMetricsCollector:
    ...
    def get_system_resource_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            ).total_seconds() if self.collection_end_time and self.collection_start_time else 0
        }
    ...
    def get_comprehensive_report(self) -> Dict[str, Any]:
        ...
        return {
            "collection_period": {
                ...
                "end_time": self.collection_end_time.isoformat() if self.collection_end_time else None,
                "duration_seconds": (
                    self.collection_end_time - self.collection_start_time
                ).total_seconds() if self.collection_end_time and self.collection_start_time else 0
            },
