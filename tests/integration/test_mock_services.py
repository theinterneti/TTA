...
class TestMockNeo4jDriver:
    ...
    def setup_method(self):
        ...
        self.driver = MockNeo4jDriver("bolt://localhost:7687", ("neo4j", "password"), self.config)
...
class TestMockRedisClient:
    ...
    async def test_expiration_handling(self):
        ...
        self.redis._data["expire_key"].expires_at = datetime.now() - timedelta(seconds=1)
...
class TestIntegrationScenarios:
    ...
    def setup_method(self):
        ...
        self.neo4j = MockNeo4jDriver("bolt://localhost:7687", ("neo4j", "password"), self.neo4j_config)
