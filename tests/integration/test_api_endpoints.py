...
from tests.fixtures.mock_data import TestUser, TestAgent, get_sample_users
...
class APITestClient:
    ...
    def authenticated_request(self, method: str, url: str, user_id: str = "test_user", **kwargs) -> Any:
...
class TestAuthenticationEndpoints:
    ...
    def test_login_with_invalid_credentials(self, api_client):
        ...
        response = api_client.client.post("/api/v1/auth/login", json={
    ...
    def test_token_verification_with_valid_token(self, api_client):
        ...
        assert response.status_code in [200, 401]  # Either valid response or user not found
