...
class TestGameplayAPI:
    ...
    def mock_gameplay_service(self):
        ...
        service.create_authenticated_session = AsyncMock(
            return_value={
                "success": True,
        ...
        service.process_validated_choice = AsyncMock(
            return_value={
                "success": True,
                "session_id": "test-session-123",
                "choice_result": {
        ...
        service.get_session_with_auth = AsyncMock(
            return_value={
                "success": True,
                "session_status": {
                    "session_id": "test-session-123",
        ...
        service.end_session_with_auth = AsyncMock(
            return_value={
                "success": True,
                "session_id": "test-session-123",
    ...
    def test_process_choice_session_not_found(
        self, client, mock_gameplay_service, mock_auth
    ):
        """Test choice processing with session not found."""
        # Mock session not found - must use AsyncMock for async methods
        mock_gameplay_service.process_validated_choice = AsyncMock(
            return_value={
                "success": False,
    ...
    def test_get_user_sessions_success(self, client, mock_gameplay_service, mock_auth):
        ...
        response = client.get(
            "/api/v1/gameplay/sessions", headers={"Authorization": "Bearer valid-token"}
        )
    ...
    def test_missing_authorization_header(self, client):
        ...
        response = client.post("/api/v1/gameplay/sessions", json={})
    ...
    def test_internal_server_error_handling(
        ...
        mock_gameplay_service.create_authenticated_session = AsyncMock(
