...
class TestPlayerProfileManager(unittest.TestCase):
    ...
    def test_create_player_profile_success(self):
        ...
        # Execute
        with patch('src.player_experience.managers.player_profile_manager.uuid.uuid4') as mock_uuid:
    ...
    def test_get_player_profile_success(self):
        ...
        # Execute
        profile = self.manager.get_player_profile(self.test_player_id, self.test_player_id)
        
        # Verify
        self.assertIsInstance(profile, PlayerProfile)
        self.assertEqual(profile.player_id, self.test_player_id)
        self.mock_repository.get_player_profile.assert_called_once_with(self.test_player_id)
    ...
    def test_delete_player_profile_success(self):
        ...
        # Execute
        result = self.manager.delete_player_profile(self.test_player_id, self.test_player_id)
        
        # Verify
        self.assertTrue(result)
        self.mock_repository.delete_player_profile.assert_called_once_with(self.test_player_id)
    ...
    def test_get_player_by_username(self):
        ...
        # Execute
        profile = self.manager.get_player_by_username(self.test_username, self.test_player_id)
        
        # Verify
        self.assertIsInstance(profile, PlayerProfile)
        self.assertEqual(profile.username, self.test_username)
        self.mock_repository.get_player_by_username.assert_called_once_with(self.test_username)
    ...
    def test_get_player_by_email(self):
        ...
        self.assertIsInstance(profile, PlayerProfile)
        self.assertEqual(profile.email, self.test_email)
        self.mock_repository.get_player_by_email.assert_called_once_with(self.test_email)
    ...
    def test_export_player_data_success(self):
        ...
        # Execute
        export_data = self.manager.export_player_data(self.test_player_id, self.test_player_id)
        ...
        # Verify data content
        self.assertEqual(export_data["player_profile"]["player_id"], self.test_player_id)
    ...
    def test_get_access_log_success(self):
        ...
        # Execute
        access_log = self.manager.get_access_log(self.test_player_id, self.test_player_id)
    ...
    def test_repository_error_handling(self):
        ...
        self.mock_repository.get_player_profile.side_effect = PlayerProfileRepositoryError("Database error")
...
class TestPlayerProfileManagerIntegration(unittest.TestCase):
    ...
    def test_full_profile_lifecycle(self):
        ...
        # Read profile
        retrieved_profile = self.manager.get_player_profile(self.test_player_id, self.test_player_id)
        ...
        # Delete profile
        delete_result = self.manager.delete_player_profile(self.test_player_id, self.test_player_id)
    ...
    def test_privacy_controls_enforcement(self):
        ...
        owner_profile = self.manager.get_player_profile(self.test_player_id, self.test_player_id)
