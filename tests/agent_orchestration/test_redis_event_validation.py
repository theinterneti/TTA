...
from src.agent_orchestration.realtime.models import (
    AgentStatusEvent, WorkflowProgressEvent, SystemMetricsEvent,
    EventType, AgentStatus, WorkflowStatus
)
...
class TestRedisEventValidation:
    ...
    async def test_event_subscription_basic(self, event_publisher, event_subscriber):
        ...
        await event_subscriber.subscribe_to_event_type(EventType.AGENT_STATUS, event_handler)
    ...
    async def test_multiple_event_types(self, event_publisher, event_subscriber):
        ...
        await event_subscriber.subscribe_to_event_type(EventType.AGENT_STATUS, event_handler)
        await event_subscriber.subscribe_to_event_type(EventType.WORKFLOW_PROGRESS, event_handler)
    ...
    async def test_event_subscriber_error_handling(self, event_subscriber):
        ...
        await event_subscriber.subscribe_to_event_type(EventType.AGENT_STATUS, failing_handler)
        await event_subscriber.subscribe_to_event_type(EventType.AGENT_STATUS, working_handler)
        ...
        assert event_subscriber.events_processed >= 1  # Working handler should have processed
    ...
    async def test_system_metrics_events(self, event_publisher, event_subscriber):
        ...
        await event_subscriber.subscribe_to_event_type(EventType.SYSTEM_METRICS, metrics_handler)
        await asyncio.sleep(0.1)
    ...
    async def test_event_statistics(self, event_publisher, event_subscriber):
        ...
        await event_subscriber.subscribe_to_event_type(EventType.AGENT_STATUS, stats_handler)
        await asyncio.sleep(0.1)
