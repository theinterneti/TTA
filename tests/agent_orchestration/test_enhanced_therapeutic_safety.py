...
class TestValidationAlgorithms:
    ...
    def test_keyword_validation(self):
        ...
        assert any(f.validation_type == ValidationType.THERAPEUTIC_BOUNDARY for f in result.findings)
    ...
    def test_crisis_detection_algorithms(self):
        ...
        for text, expected_crisis in crisis_cases:
            ...
            assert result.level == SafetyLevel.BLOCKED or result.level == SafetyLevel.WARNING
...
class TestCrisisDetection:
    ...
    def test_false_positive_prevention(self):
        ...
        for phrase in normal_sad_phrases:
            ...
            assert not result.crisis_detected or len(result.crisis_types) == 0, f"False positive for: {phrase}"
    ...
    def test_therapeutic_tone(self):
        ...
        for text in crisis_texts:
            ...
            if result.alternative_content:
                ...
                assert any(word in alt for word in supportive_words), f"No supportive language in: {alt}"
