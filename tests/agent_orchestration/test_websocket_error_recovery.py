...
class TestWebSocketErrorRecovery:
    ...
    async def test_connection_recovery_with_state_restoration(self, websocket_manager):
        ...
        task1 = asyncio.create_task(websocket_manager.handle_connection(mock_websocket1))
        ...
        task2 = asyncio.create_task(websocket_manager.handle_connection(mock_websocket2))
        await asyncio.sleep(0.1)
