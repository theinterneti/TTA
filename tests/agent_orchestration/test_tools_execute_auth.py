# Logseq: [[TTA.dev/Tests/Agent_orchestration/Test_tools_execute_auth]]
import asyncio
import os
...
async def test_tools_execute_auth_authorized_and_allowed_tools(redis_client):
    ...
    bad = client.post(
        "/tools/execute",
        headers={"X-AO-DIAG-KEY": "secret"},
        json={"tool_name": "other", "version": "1.0.0", "arguments": {}},
    )
