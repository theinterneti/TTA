...
async def test_callable_registry_and_execute(redis_client):
    ...
    resp = client.post("/tools/execute", json={"tool_name": "math.add", "version": "2.0.0", "arguments": {"a": 2, "b": 4}})
    ...
    resp2 = client.post("/tools/execute", json={"tool_name": "bad", "version": "1.0.0", "arguments": {}})
