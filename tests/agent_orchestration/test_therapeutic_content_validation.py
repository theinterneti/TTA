...
class TestTherapeuticContentValidation:
    ...
    async def test_crisis_intervention_content_flow(
        ...
        for i, scenario in enumerate(crisis_scenarios):
            ...
            assert (
                crisis_response["intervention_type"]
            ...
            supportive_content = any(
                keyword in story.lower() for keyword in supportive_keywords
            )
            ...
            triggering_content = any(
                keyword in story.lower() for keyword in triggering_keywords
            )
        ...
        for i, scenario in enumerate(boundary_test_scenarios):
            ...
            if scenario["should_decline"]:
                ...
                boundary_respected = any(
                    element in story
                    for element in scenario["expected_response_elements"]
                )
                ...
                provides_medical_advice = any(
                    keyword in story for keyword in medical_advice_keywords
                )
    ...
    async def test_therapeutic_content_personalization(
        ...
        for i, scenario in enumerate(personalization_scenarios):
            ...
            follow_up_result = (
                await therapeutic_orchestration_service.process_user_input(
