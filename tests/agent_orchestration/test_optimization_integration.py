...
async def test_response_time_collector_integration():
    ...
    try:
        ...
        # Test statistics
        stats = collector.get_stats(ResponseTimeCategory.MESSAGE_PROCESSING, "test_message_send")
        ...
        workflow_stats = collector.get_stats(ResponseTimeCategory.WORKFLOW_EXECUTION, "test_workflow")
...
async def test_full_optimization_system_integration():
    ...
    engine = OptimizationEngine(
        ...
        enabled_strategies=[OptimizationStrategy.CONSERVATIVE, OptimizationStrategy.STATISTICAL],
    )
    ...
    try:
        ...
        operations = [
            ...
            ("slow_operation", ResponseTimeCategory.SYSTEM_OPERATION, 7.5, True),  # Slow
            ("failed_operation", ResponseTimeCategory.API_REQUEST, 1.0, False),  # Failed
        ]
