...
from src.components.gameplay_loop.narrative.events import (
    EventType, EventPriority, NarrativeEvent, SceneEvent, ChoiceEvent,
    EventBus, create_scene_event, create_choice_event
)
from src.components.gameplay_loop.narrative.engine import (
    NarrativeEngine, NarrativeEngineConfig, NarrativeMode, EngineState
)
from src.components.gameplay_loop.narrative.scene_manager import (
    SceneManager, SceneContext, SceneStatus, SceneValidator
)
from src.components.gameplay_loop.narrative.choice_processor import (
    ChoiceProcessor, ChoiceContext, ChoiceValidator, ChoiceValidationResult
)
from src.components.gameplay_loop.models.core import (
    NarrativeScene, SceneType, UserChoice, ChoiceType
)
...
class TestSceneContext:
    ...
    def test_therapeutic_moment_recording(self):
        ...
        context.record_therapeutic_moment(
            "skill_practice",
            "User practiced deep breathing technique",
            0.9
        )
...
class TestChoiceValidator:
    ...
    def test_therapeutic_mismatch_validation(self):
        ...
        assert any("not therapeutically aligned" in issue for issue in context.validation_issues)
