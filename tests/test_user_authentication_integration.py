...
from src.player_experience.database.user_repository import UserRepository, User
...
from src.player_experience.services.user_management_service import UserManagementService
from src.player_experience.models.auth import (
    UserRole, UserRegistration, UserCredentials, SecuritySettings, MFAConfig
)
...
class TestUserAuthenticationIntegration:
    ...
    def test_user_registration_flow(self, auth_service, sample_registration):
        ...
        user = auth_service.user_repository.get_user_by_username(sample_registration.username)
    ...
    def test_user_authentication_flow(self, auth_service, sample_registration):
        ...
        credentials = UserCredentials(
            username=sample_registration.username,
            password=sample_registration.password
        )
    ...
    def test_failed_authentication_tracking(self, auth_service, sample_registration):
        ...
        authenticated_user = auth_service.authenticate_user(wrong_credentials, "127.0.0.1")
    ...
    def test_account_lockout_and_unlock(self, auth_service, sample_registration):
        ...
        authenticated_user = auth_service.authenticate_user(correct_credentials, "127.0.0.1")
        assert authenticated_user is not None
