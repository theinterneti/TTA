...
class MockDataGenerator:
    ...
    @staticmethod
    def create_test_sessions(user_ids: List[str], count_per_user: int = 2) -> List[TestSession]:
    ...
    @staticmethod
    def create_performance_test_data(operation_count: int = 100) -> List[Dict[str, Any]]:
...
class TestScenarios:
    ...
    @staticmethod
    def load_test_scenario(concurrent_users: int = 10, duration_seconds: int = 60) -> Dict[str, Any]:
