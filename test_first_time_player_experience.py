...
from src.player_experience.services.conversational_character_service import ConversationalCharacterService
from src.player_experience.managers.character_avatar_manager import CharacterAvatarManager
from src.player_experience.managers.world_management_module import WorldManagementModule
from src.player_experience.services.therapeutic_world_selection_service import TherapeuticWorldSelectionService
from src.player_experience.services.story_initialization_service import StoryInitializationService
from src.player_experience.services.character_to_gameplay_transition import CharacterToGameplayTransition
from src.components.user_experience.therapeutic_chat_interface import TherapeuticChatInterface
from src.components.therapeutic_systems.gameplay_loop_controller import TherapeuticGameplayLoopController as GameplayLoopController
from src.player_experience.models.character import Character, TherapeuticProfile, TherapeuticGoal
from src.player_experience.models.conversation_state import ConversationState, ConversationStage
from src.components.user_experience.therapeutic_chat_interface import ChatMessage, MessageType, TherapeuticContext
    ...
    try:
        ...
        for user_input, expected_stage in conversation_stages:
            ...
            if completion_result:
                print(f"✓ Character creation completed successfully")
        ...
        world_selection_service = TherapeuticWorldSelectionService()
        ...
        if character_data:
            ...
            if session_data:
                print(f"✓ Character-world integration successful")
        ...
        if story_context:
            print(f"✓ Story context initialized")
