#!/usr/bin/env python3
"""
Test Agent Tool Server (DEVELOPMENT ONLY)

This script tests the agent tool server by running it and checking if it's operational.
...
def main():
    """
    Main function to test the agent tool server.
    """
    ...
    try:
        os.system("pkill -f 'python3 examples/mcp/agent_tool_server.py'")
    except Exception:
        pass
