#!/usr/bin/env python3
"""
Simple MCP Server Test (DEVELOPMENT ONLY)

This script demonstrates how to test an MCP server by running it directly.
...
def main():
    ...
    try:
        os.system("pkill -f 'python3 examples/mcp/basic_server.py'")
    except Exception:
        pass
