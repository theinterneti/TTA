#!/usr/bin/env python3
"""
Test Agent Adapter (DEVELOPMENT ONLY)

This script tests the agent adapter by running the agent adapter example and checking if it's operational.
...
def main():
    """
    Main function to test the agent adapter.
    """
    ...
    try:
        ...
        server_process = subprocess.Popen(
            ["python3", "examples/mcp/agent_adapter_example.py"],
        ...
        if server_process.poll() is None:
            print("Agent adapter is running!")
    ...
    try:
        os.system("pkill -f 'python3 examples/mcp/agent_adapter_example.py'")
    except Exception:
        pass
