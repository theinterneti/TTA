"""
MCP Server Types for the TTA project.

This module defines the different types of MCP servers that can be used in the TTA project.
"""
...
class MCPServerType(Enum):
    ...
    # Agent tool server for interacting with TTA agents
    AGENT_TOOL = auto()
    ...
    def from_string(cls, server_type_str: str):
        ...
        try:
            ...
            raise ValueError(f"Unknown server type: {server_type_str}") from e
