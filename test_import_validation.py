...
def test_narrative_therapy_integration():
    ...
    try:
        from components.user_experience.therapeutic_chat_interface import TherapeuticChatInterface
        ...
        from components.user_experience.therapeutic_chat_interface import ChatMessage, MessageType, TherapeuticContext
        ...
        from components.user_experience.therapeutic_chat_interface import TherapeuticFramework
