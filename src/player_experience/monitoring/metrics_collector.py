...
class MetricsCollector:
    ...
    def _record_metric_point(self, name: str, value: Union[int, float], 
    ...
    def get_user_engagement_metrics(self) -> UserEngagementMetrics:
        ...
        with self.lock:
            return UserEngagementMetrics(
                ...
                therapeutic_interactions=self.counters.get("therapeutic_interactions", 0),
                ...
                successful_interventions=self.counters.get("successful_interventions", 0),
            )
    
    def add_metric_callback(self, metric_name: str, callback: Callable[[str, Any], None]):
        """Add a callback for metric changes."""
        self.metric_callbacks[metric_name].append(callback)
    
    def remove_metric_callback(self, metric_name: str, callback: Callable[[str, Any], None]):
...
def record_therapeutic_interaction(interaction_type: str, success: bool, user_satisfaction: Optional[float] = None):
