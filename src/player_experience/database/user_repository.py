    ...
    def from_dict(cls, data: dict[str, Any]) -> "User":
        ...
        if data.get("locked_until"):
            locked_until = datetime.fromisoformat(
                data["locked_until"].replace("Z", "+00:00")
            )
...
class UserRepository:
        ...
        for attempt in range(attempts):
            try:
                ...
                if ("AuthenticationRateLimit" in emsg) or (
                    ...
                    raise UserRepositoryError(f"Failed to connect to Neo4j: {e}") from e
    ...
    def get_user_by_id(self, user_id: str) -> User | None:
        ...
        try:
            ...
            raise UserRepositoryError(f"Error retrieving user: {e}") from e
    ...
    def get_user_by_username(self, username: str) -> User | None:
        ...
        try:
            ...
            raise UserRepositoryError(f"Error retrieving user by username: {e}") from e
    ...
    def get_user_by_email(self, email: str) -> User | None:
        ...
        try:
            ...
            raise UserRepositoryError(f"Error retrieving user by email: {e}") from e
    ...
    def update_user(self, user: User) -> bool:
        ...
        try:
            ...
            raise UserRepositoryError(f"Error updating user: {e}") from e
    ...
    def delete_user(self, user_id: str) -> bool:
        ...
        try:
            ...
            raise UserRepositoryError(f"Error deleting user: {e}") from e
    ...
    def username_exists(self, username: str) -> bool:
        ...
        try:
            ...
            raise UserRepositoryError(f"Error checking username existence: {e}") from e
    ...
    def email_exists(self, email: str) -> bool:
        ...
        try:
            ...
            raise UserRepositoryError(f"Error checking email existence: {e}") from e
    ...
    def get_users_by_role(self, role: UserRole) -> list[User]:
        ...
        try:
            ...
            raise UserRepositoryError(f"Error retrieving users by role: {e}") from e
