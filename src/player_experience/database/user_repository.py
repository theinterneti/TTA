...
class UserRepository:
    ...
    def create_user(
        ...
        try:
            ...
            player_profile.privacy_settings.password_hash = password_hash  # type: ignore[attr-defined]
            player_profile.privacy_settings.role = role.value  # type: ignore[attr-defined]
