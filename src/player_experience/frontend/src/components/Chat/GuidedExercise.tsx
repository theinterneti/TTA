...
const GuidedExercise: React.FC<GuidedExerciseProps> = ({
  ...
  // Handle step completion - defined before useEffect to avoid hoisting issues
  ...
  }, [isTimerRunning, timer, handleStepComplete]);
  ...
  // handleStepComplete moved above to avoid hoisting issues
    ...
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4 my-3">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-2">
          <div className="text-blue-600">{getExerciseIcon()}</div>
      ...
      {/* Instructions */}
      <p className="text-sm text-blue-800 mb-4">{exercise.instructions}</p>
          ...
          >
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1.5a1.5 1.5 0 011.5 1.5v1a1.5 1.5 0 01-1.5 1.5H9m0-5a1.5 1.5 0 011.5-1.5H12m-3 5h3m-3 0h.375a1.125 1.125 0 011.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125H9m0 0H5.625c-.621 0-1.125-.504-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125H9z"
              />
            </svg>
