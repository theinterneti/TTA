...
class CrisisContactInfo:
    ...
    crisis_hotline_preference: Optional[str] = None
...
class TherapeuticPreferences:
    ...
    crisis_contact_info: Optional[CrisisContactInfo] = None
    ...
    def __post_init__(self):
        ...
        if self.session_duration_preference < 10 or self.session_duration_preference > 120:
...
class PlayerProfile:
    ...
    email: str
    created_at: datetime
    therapeutic_preferences: TherapeuticPreferences = field(default_factory=TherapeuticPreferences)
    privacy_settings: PrivacySettings = field(default_factory=PrivacySettings)
    characters: List[str] = field(default_factory=list)  # Character IDs
    active_sessions: Dict[str, str] = field(default_factory=dict)  # character_id -> session_id
    ...
    def get_active_session(self, character_id: str) -> Optional[str]:
