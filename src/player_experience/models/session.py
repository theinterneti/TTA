...
from .enums import ProgressMarkerType, SessionStatus, TherapeuticApproach
...
class SessionContext:
    ...
    def record_emotional_state(self, emotional_data: dict[str, Any]) -> None:
        ...
        emotional_entry = {"timestamp": datetime.now(), "data": emotional_data}
...
class Recommendation:
    ...
    target_entity_id: str | None = None  # ID of recommended world, character, etc.
    reasoning: str = ""
    created_at: datetime = field(default_factory=datetime.now)
...
class PlayerDashboard:
    ...
    player_id: str
    active_characters: list[dict[str, Any]] = field(
    ...
    most_effective_approach: TherapeuticApproach | None = None
    preferred_session_time: str | None = None  # "morning", "afternoon", "evening"
    ...
    def add_recommendation(self, recommendation: Recommendation) -> None:
        ...
        self.recommendations = [
            ...
            if r.recommendation_id != recommendation.recommendation_id
        ]
