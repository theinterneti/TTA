...
class DeploymentValidator:
    ...
    def __init__(self, host: str = "localhost", port: int = 8080, environment: str = "development"):
        self.host = host
        self.port = port
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                get_response = self.session.get(
                    f"{self.base_url}/api/v1/players/{player_id}",
                    timeout=10
                )
        ...
        try:
            ...
            if char_response.status_code == 201:
                ...
                self.log_test_result(
                    "Character Management API",
                    success,
                    "Character CRUD operations working correctly" if success else "Character retrieval failed"
                )
                return success
            else:
                # Clean up player
    ...
    def test_security_headers(self) -> bool:
        ...
        try:
            ...
            success = passed_checks >= (total_checks * 0.7)  # At least 70% of checks should pass
    ...
    def print_summary(self, summary: Dict[str, Any]):
        ...
        overall_status = "✅ DEPLOYMENT SUCCESSFUL" if summary['overall_success'] else "❌ DEPLOYMENT FAILED"
...
async def main():
    """Main function."""
    parser = argparse.ArgumentParser(description="Validate Player Experience Interface deployment")
