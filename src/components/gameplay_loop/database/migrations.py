...
from src.components.gameplay_loop.database.schema import GraphSchema, GraphIndexes
...
class MigrationManager:
    ...
    async def record_migration(self, version: str, description: str, success: bool) -> None:
...
async def setup_database(connection_manager: Neo4jConnectionManager) -> bool:
    ...
    if success:
        ...
        logger.info(f"Database setup complete. Applied {status['applied_migrations']} migrations.")
    else:
