...
try:
    from ..integrations.character_arc_integration import CharacterArcIntegration
...
# PlayerInteraction is imported from character_arc_interfaces - removing duplicate definition
