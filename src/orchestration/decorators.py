            ...
            while attempt <= max_attempts:
                try:
                    ...
                    if attempt == max_attempts:
                        logger.error(f"Final attempt {attempt}/{max_attempts} for {func.__name__} failed: {e}")
                        raise
    ...
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        for param_name, param_value in bound_args.arguments.items():
            ...
            if param.annotation != inspect.Parameter.empty:
                ...
                if not isinstance(param_value, param.annotation) and param.annotation is not Any:
    ...
    def decorator(func: F) -> F:
        ...
        def wrapper(self: Any, *args: Any, **kwargs: Any) -> Any:
            ...
            if not hasattr(self, 'config'):
                raise AttributeError(f"{self.__class__.__name__} has no 'config' attribute")
