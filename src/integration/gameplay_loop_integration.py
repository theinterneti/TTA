...
from ..player_experience.api.auth import get_current_player, AuthenticationError
...
class GameplayLoopIntegration:
    ...
    def __init__(self, 
                 ...
                 agent_orchestration: Optional[AgentOrchestrationService] = None,
    ...
    async def create_authenticated_session(self,
                                         auth_token: str,
                                         therapeutic_context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if self.safety_service and choice_result.get("next_scene"):
                ...
                if scene_description:
                    validation_result = await self.safety_service.validate_text(scene_description)
                    ...
                    if validation_result.level.value >= 8:  # High risk level
                        ...
                        choice_result["safety_warning"] = "Content was modified for therapeutic safety"
            ...
            if self.agent_orchestration:
                try:
                    ...
                    logger.info(f"Agent orchestration integration point for session {session_id}")
                except Exception as e:
    ...
    def get_integration_status(self) -> Dict[str, Any]:
        ...
        return {
            "gameplay_component": {
                ...
                "status": self.gameplay_component.get_status_info() if self.gameplay_component else None
            },
            "agent_orchestration": {
                "available": self.agent_orchestration is not None,
                "initialized": getattr(self.agent_orchestration, '_initialized', False) if self.agent_orchestration else False
            },
            "safety_service": {
                "available": self.safety_service is not None,
                "enabled": self.safety_service.is_enabled() if self.safety_service else False
            }
        }
