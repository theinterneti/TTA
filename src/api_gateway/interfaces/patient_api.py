...
from ...components.therapeutic_systems_enhanced.therapeutic_integration_system import TherapeuticIntegrationSystem
from ...components.therapeutic_systems_enhanced.emotional_safety_system import EmotionalSafetySystem
from ...components.therapeutic_systems_enhanced.adaptive_difficulty_engine import AdaptiveDifficultyEngine
from ...components.therapeutic_systems_enhanced.character_development_system import CharacterDevelopmentSystem
...
async def start_therapeutic_session(
    ...
    try:
        ...
        response = TherapeuticSessionResponse(
            ...
            current_scenario=initial_scenario.get("content", "Welcome to your therapeutic journey...")
        )
        
        logger.info(f"Started therapeutic session {session_id} for patient {patient_id}")
        return response
...
async def trigger_intervention(
    ...
    try:
        ...
        logger.info(f"Triggered {intervention.intervention_type} intervention for patient {patient_id}")
        return {
...
async def trigger_safety_intervention(
    ...
    try:
        intervention_type = "crisis_support" if safety_assessment.get("risk_level") == "crisis" else "emotional_support"
