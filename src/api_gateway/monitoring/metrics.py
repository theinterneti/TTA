...
ACTIVE_CONNECTIONS = Gauge(
    "gateway_active_connections", "Number of active connections to the gateway"
)
...
THERAPEUTIC_SESSIONS = Gauge(
    "gateway_therapeutic_sessions_active", "Number of active therapeutic sessions"
)
...
class MetricsCollector:
    ...
    def record_crisis_event(self, severity: str, intervention_type: str):
        ...
        CRISIS_EVENTS.labels(
            severity=severity, intervention_type=intervention_type
        ).inc()
    ...
    def record_auth_event(self, event_type: str, status: str):
        ...
        AUTHENTICATION_EVENTS.labels(event_type=event_type, status=status).inc()
