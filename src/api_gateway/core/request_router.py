...
from ..models import RouteRule, RoutingConfig, RequestMethod, RouteType
from ..services import ServiceDiscoveryManager
from ..utils import require_auth, require_role, require_permission, get_user_context
...
class RequestRouter:
    ...
    def __init__(self, gateway_core: GatewayCore, discovery_manager: ServiceDiscoveryManager):
        """
    ...
    async def initialize(self) -> None:
        ...
        logger.info(f"Request router initialized with {len(self._default_routes)} default routes")
...
def create_gateway_router(gateway_core: GatewayCore, discovery_manager: ServiceDiscoveryManager) -> APIRouter:
    """
