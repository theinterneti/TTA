...
class LoadBalancer(ABC):
    ...
    @abstractmethod
    def select_service(self, services: List[ServiceInfo], 
                      therapeutic_priority: bool = False,
                      crisis_mode: bool = False) -> Optional[ServiceInfo]:
        """
...
class TherapeuticPriorityLoadBalancer(LoadBalancer):
    ...
    def select_service(self, services: List[ServiceInfo], 
        ...
        non_therapeutic_services = [s for s in healthy_services if not s.therapeutic_priority]
