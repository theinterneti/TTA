...
class CircuitBreakerConfig:
    ...
    therapeutic_recovery_timeout: float = 30.0  # Faster recovery for therapeutic services
...
class CircuitBreaker:
    ...
    def __init__(self, service_info: ServiceInfo, config: Optional[CircuitBreakerConfig] = None):
        """
    ...
    async def _is_call_allowed(self, therapeutic_request: bool, crisis_mode: bool) -> bool:
        """
    ...
    async def _record_result(self, success: bool, response_time: float, therapeutic_request: bool):
        """
...
class CircuitBreakerManager:
    ...
    async def call_service(self, service_info: ServiceInfo,
                          call_func: Callable, *args,
                          therapeutic_request: bool = False,
                          crisis_mode: bool = False, **kwargs) -> Any:
        """
