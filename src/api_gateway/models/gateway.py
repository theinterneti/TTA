...
class GatewayRequest(BaseModel):
    ...
    auth_context: Optional[Dict[str, Any]] = Field(default=None, description="Authentication context")
    
    # Timestamps
    received_at: datetime = Field(default_factory=datetime.utcnow, description="Request received timestamp")
    
    # Therapeutic context
    therapeutic_session_id: Optional[UUID] = Field(default=None, description="Therapeutic session ID")
...
class GatewayResponse(BaseModel):
    ...
    service_name: Optional[str] = Field(default=None, description="Service that handled the request")
    processing_time: float = Field(..., description="Processing time in seconds")
    
    # Timestamps
    completed_at: datetime = Field(default_factory=datetime.utcnow, description="Response completion timestamp")
...
class RouteRule(BaseModel):
    ...
    methods: List[RequestMethod] = Field(default_factory=list, description="HTTP methods to match")
    ...
    therapeutic_priority: bool = Field(default=False, description="Therapeutic priority routing")
    crisis_bypass: bool = Field(default=False, description="Bypass normal routing for crisis")
...
class RoutingConfig(BaseModel):
    ...
    # Load balancing
    default_load_balancing: str = Field(default="round_robin", description="Default load balancing algorithm")
    health_check_enabled: bool = Field(default=True, description="Enable health checks for routing")
...
class WebSocketConnection(BaseModel):
    ...
    # Therapeutic context
    therapeutic_session_id: Optional[UUID] = Field(default=None, description="Therapeutic session ID")
    is_therapeutic: bool = Field(default=False, description="Therapeutic connection flag")
