...
class ResponseTimeMonitor:
    ...
    async def _record_metric(self, metric: ResponseTimeMetric) -> None:
        ...
        if metric.performance_level in [PerformanceLevel.SLOW, PerformanceLevel.CRITICAL]:
    ...
    def _calculate_statistics(
        ...
        successful_operations = [
            ...
            if not metric.metadata.get("error")
        ]
...
_response_time_monitor: Optional[ResponseTimeMonitor] = None
