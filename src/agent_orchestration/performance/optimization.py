...
from .response_time_monitor import ResponseTimeMonitor, OperationType
    ...
    async def _schedule_fastest_first(
        ...
        for agent_type in request.required_agents:
            ...
            available_agents = [
                ...
                if (profile.agent_type == agent_type and 
                    profile.load_level != AgentLoadLevel.OVERLOADED)
            ]
    ...
    async def _update_agent_profiles(self) -> None:
        ...
        for agent_id, profile in self.agent_profiles.items():
            ...
            if agent_stats:
                ...
                profile.performance_trend = (old_response_time - profile.average_response_time) / max(old_response_time, 0.1)
