...
try:
    from agents.ipa import process_input, IntentSchema
...
class IPAAdapter:
    ...
    def __init__(self, fallback_to_mock: bool = True, retry_config: Optional[RetryConfig] = None):
...
class WBAAdapter:
    ...
    def __init__(self, neo4j_manager=None, tools: Optional[Dict[str, Any]] = None, fallback_to_mock: bool = True, retry_config: Optional[RetryConfig] = None):
        self.fallback_to_mock = fallback_to_mock
        self.retry_config = retry_config or RetryConfig()
    ...
    async def process_world_request(self, world_id: str, updates: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
    ...
    def _mock_process_world(self, world_id: str, updates: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
...
class NGAAdapter:
    ...
    async def generate_narrative(self, prompt: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Transform result to orchestration system format
            story_text = result.get("response", result.get("story", f"Generated story for: {prompt[:64]}..."))
    ...
    def _mock_generate_narrative(self, prompt: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
