...
from .models import SystemMetricsEvent, AgentStatusEvent, WorkflowProgressEvent
from .monitoring_integration import MonitoringEventIntegrator
...
class RealtimeDashboardManager:
    ...
    def __init__(
        ...
        self.active_subscriptions: Dict[str, Set[DashboardType]] = {}  # connection_id -> dashboard_types
            ...
            try:
                ...
                for dashboard_type in DashboardType:
                    ...
                    if current_time - last_update >= self.config.update_interval:
                        ...
                        self.update_counts[dashboard_type] = self.update_counts.get(dashboard_type, 0) + 1
    ...
    async def _update_agent_performance_data(self) -> None:
        ...
        dashboard_data = DashboardData(
            ...
            data={
                ...
                "active_agents": len([m for m in agent_metrics.values() if m.get("status") == "active"]),
                "agent_details": {
                    agent_id: {
    ...
    def _calculate_performance_summary(self, agent_metrics: Dict[str, Dict[str, Any]]) -> Dict[str, Any]:
        """Calculate performance summary from agent metrics."""
        if not agent_metrics:
            return {"avg_response_time": 0.0, "total_throughput": 0.0, "avg_error_rate": 0.0}
