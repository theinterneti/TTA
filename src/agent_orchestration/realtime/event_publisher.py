...
# Logseq: [[TTA.dev/Agent_orchestration/Realtime/Event_publisher]]
...
class EventPublisher:
    ...
    def __init__(
        ...
        logger.info(
            f"EventPublisher initialized: enabled={enabled}, redis={'available' if redis_client else 'unavailable'}"
        )
