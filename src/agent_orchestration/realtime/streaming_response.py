...
from .progressive_feedback import ProgressiveFeedbackManager, OperationProgress
from .models import WebSocketEvent, ProgressiveFeedbackEvent
...
class StreamingWorkflowResponse:
    ...
    async def send_chunk(self, data: Union[str, Dict[str, Any]], chunk_type: str = "data") -> None:
    ...
    async def send_error(self, error_message: str, error_details: Optional[Dict[str, Any]] = None) -> None:
    ...
    async def complete(self, final_result: Optional[Dict[str, Any]] = None) -> None:
    ...
    def _format_chunk(self, data: Union[str, Dict[str, Any]], chunk_type: str) -> str:
...
class StreamingResponseManager:
    ...
    def __init__(self, feedback_manager: Optional[ProgressiveFeedbackManager] = None):
        self.feedback_manager = feedback_manager
    ...
    def get_streaming_response(self, workflow_id: str) -> Optional[StreamingWorkflowResponse]:
    ...
    async def complete_stream(self, workflow_id: str, final_result: Optional[Dict[str, Any]] = None) -> bool:
    ...
    def get_active_streams(self, user_id: Optional[str] = None) -> List[Dict[str, Any]]:
