...
from .models import (
    ...
    create_agent_status_event, create_workflow_progress_event, create_error_event
)
        ...
        while self.is_running:
            try:
                ...
                for error_report in self.active_errors.values():
                    ...
                    if (current_time - error_report.timestamp > self.escalation_timeout and
                        error_report.escalation_level == 0 and
                        error_report.severity in [ErrorSeverity.HIGH, ErrorSeverity.CRITICAL]):
