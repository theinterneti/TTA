...
from .models import (
    AgentCapability, AgentCapabilitySet, CapabilityMatchCriteria, 
    CapabilityMatchResult, CapabilityType, CapabilityStatus
)
...
class CapabilityMatcher:
    ...
    def match_capabilities(
        ...
        try:
            if strategy == MatchingStrategy.EXACT_MATCH:
                ...
                logger.warning(f"Unknown matching strategy: {strategy}, falling back to weighted_score")
                matches = self._weighted_score_match(capability_sets, criteria)
    ...
    def _check_agent_availability(self, cap_set: AgentCapabilitySet, criteria: CapabilityMatchCriteria) -> bool:
    ...
    def _is_exact_match(self, capability: AgentCapability, criteria: CapabilityMatchCriteria) -> bool:
    ...
    def _meets_basic_criteria(self, capability: AgentCapability, criteria: CapabilityMatchCriteria) -> bool:
    ...
    def _check_version_match(self, capability: AgentCapability, criteria: CapabilityMatchCriteria) -> bool:
    ...
    def _check_performance_match(self, capability: AgentCapability, criteria: CapabilityMatchCriteria) -> bool:
    ...
    def _calculate_score_components(self, capability: AgentCapability, criteria: CapabilityMatchCriteria) -> Dict[str, Any]:
        ...
        components["exact_match"] = (
            components["name_score"] == 1.0 and 
            components["type_score"] == 1.0 and 
            components["version_score"] == 1.0 and 
            components["performance_score"] == 1.0
        )
        
        # At least one component must score
        score_values = [components["name_score"], components["type_score"],
                       components["version_score"], components["performance_score"]]
    ...
    def _calculate_fuzzy_score(self, capability: AgentCapability, criteria: CapabilityMatchCriteria) -> float:
    ...
    def _calculate_semantic_score(self, capability: AgentCapability, criteria: CapabilityMatchCriteria) -> float:
        ...
        if criteria.capability_name and capability.description:
            desc_similarity = self._keyword_similarity(capability.description, criteria.capability_name)
