...
# Logseq: [[TTA.dev/Observability_integration/Primitives/Router]]
...
class RouterPrimitive(WorkflowPrimitive[Any, Any]):
    ...
    def __init__(
        ...
        logger.info(
            f"RouterPrimitive initialized with {len(routes)} routes: "
            f"{list(routes.keys())}"
        )
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"RouterPrimitive(routes={list(self.routes.keys())}, "
